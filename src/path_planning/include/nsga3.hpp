...
void NSGA3::gen_refpointsND(vector<TRefpoint> *rps, TRefpoint *rp, size_t left, size_t count)
{
...
TParetofront::TPfronts NSGA3::nondominatedsort()
{
	int rank = 1, count = 0;
...
void NSGA3::normalize(TParetofront::TPfronts Fronts) {
...
void NSGA3::associate(TParetofront::TPfronts Fronts)
{
...
void NSGA3::run(size_t ngen, size_t run) {
...
void NSGA3::save_front(char file_name[512])
{
	std::fstream fout;
